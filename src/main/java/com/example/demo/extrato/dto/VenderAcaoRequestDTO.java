...
public class VenderAcaoRequestDTO {
    ...
    // Constructors
    public VenderAcaoRequestDTO() {}

    public VenderAcaoRequestDTO(Long investimentoId, BigDecimal quantidade, BigDecimal precoUnitario) {
